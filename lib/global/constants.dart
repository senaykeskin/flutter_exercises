...
final BorderRadius radius20 = BorderRadius.circular(20);
final BorderRadius radius25 = BorderRadius.circular(25);

final EdgeInsets onlyTop15 = EdgeInsets.only(top: 15);
final EdgeInsets onlyTop50 = EdgeInsets.only(top: 50);
